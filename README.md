...
var yearList = [1990, 1995, 1999, 2005, 2010, 2015, 2023];
...
var forestCol = ee.ImageCollection(yearList.map(function(year){
  ...
  // Bandmap
  var bandMap = { NIR: image.select('B5'), SWIR: image.select('B4') };
  ...
  // Forest
  var forest = vi.gt(0.4).selfMask().rename('forest').toUint32();
...
//Map.add(forestAreaChart)
// Deforestation legend
var labelList = ['1990 - 1995', '1995 - 2000', '2000 - 2005', '2005 - 2010', '2010 - 2015', '2015 - 2023', 'Current forest'];
